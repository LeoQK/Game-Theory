...
global_storage_episodes = []
global_storage_episodes2 = []
global_storage_episodes3 = []
global_storage_episodes4 = []
global_storage_player_eq_utilities = []
global_storage_player_utilities = []
global_storage_player_names = []
global_storage_player_names2 = []
global_storage_player_names3 = []
global_storage_game_type = []
global_storage_game_type2 = []
global_storage_game_states = []
global_storage_memory = []
global_storage_discount_rate = []
global_storage_transfer_balance = []
...
for e in range(2):
    ...
    for i in range(10):
        ...
        global_storage_player_eq_utilities.append(ONE_P1_EQ_utility)
        global_storage_player_eq_utilities.append(ONE_P2_EQ_utility)
        global_storage_player_eq_utilities.append(TWO_P1_EQ_utility)
        global_storage_player_eq_utilities.append(TWO_P2_EQ_utility)

        global_storage_player_names.append("P1")
        global_storage_player_names.append("P2")
        global_storage_player_names.append("P1")
        global_storage_player_names.append("P2")
        global_storage_game_type.append("ONE")
        global_storage_game_type.append("ONE")
        global_storage_game_type.append("TWO")
        global_storage_game_type.append("TWO")
        ...
        # UPDATE GLOBAL STORAGE OF MEMORY AND PLAYER NAMES

        ##################################################

        global_storage_memory.append(sum(P1s_memory) / len(P1s_memory))
        global_storage_memory.append(sum(P2s_memory) / len(P2s_memory))
        global_storage_player_names3.append("PP1")
        global_storage_player_names3.append("PP2")


        ###############################

        # PRE-PROCESSING 2 FOR TRANSFER
        ...
        global_storage_discount_rate.append(BROKER_discount_rate)
        ...
        # UPDATE GLOBAL STORAGE OF UTILITIES, PLAYERS, STATES, GAME TYPE

        ################################################################

        global_storage_player_utilities.append(ONE_P1_cc)
        global_storage_player_utilities.append(ONE_P2_cc)
        global_storage_player_utilities.append(ONE_P1_cd)
        global_storage_player_utilities.append(ONE_P2_dc)
        global_storage_player_utilities.append(ONE_P1_dc)
        global_storage_player_utilities.append(ONE_P2_cd)
        global_storage_player_utilities.append(ONE_P1_dd)
        global_storage_player_utilities.append(ONE_P2_dd)

        global_storage_player_names2.append("P1")
        global_storage_player_names2.append("P2")
        global_storage_player_names2.append("P1")
        global_storage_player_names2.append("P2")
        global_storage_player_names2.append("P1")
        global_storage_player_names2.append("P2")
        ...
        global_storage_game_states.append("cc")
        global_storage_game_states.append("cc")
        global_storage_game_states.append("cd")
        global_storage_game_states.append("dc")
        global_storage_game_states.append("dc")
        global_storage_game_states.append("cd")
        global_storage_game_states.append("dd")
        global_storage_game_states.append("dd")

        global_storage_game_type2.append("ONE")
        global_storage_game_type2.append("ONE")
        global_storage_game_type2.append("ONE")
        global_storage_game_type2.append("ONE")
        global_storage_game_type2.append("ONE")
        ...
        global_storage_player_utilities.append(TWO_P1_cc)
        global_storage_player_utilities.append(TWO_P2_cc)
        global_storage_player_utilities.append(TWO_P1_cd)
        global_storage_player_utilities.append(TWO_P2_dc)
        global_storage_player_utilities.append(TWO_P1_dc)
        global_storage_player_utilities.append(TWO_P2_cd)
        global_storage_player_utilities.append(TWO_P1_dd)
        global_storage_player_utilities.append(TWO_P2_dd)
        ...
        global_storage_game_type2.append("TWO")
        global_storage_game_type2.append("TWO")
        global_storage_game_type2.append("TWO")
        global_storage_game_type2.append("TWO")
        global_storage_game_type2.append("TWO")
        ...
        global_storage_transfer_balance.append(TWO_P1_transfer_discounted - ONE_P1_transfer)
        global_storage_transfer_balance.append(TWO_P2_transfer_discounted - ONE_P2_transfer)
        global_storage_transfer_balance.append(ONE_P1_transfer_discounted - TWO_P1_transfer)
        global_storage_transfer_balance.append(ONE_P1_transfer_discounted - TWO_P1_transfer)
    ...
    # UPDATE GLOBAL STORAGE OF EPISODES

    ###################################

    global_storage_episodes.append(i_storage)
    global_storage_episodes2.append(i_storage2)
    global_storage_episodes3.append(i_storage3)
    global_storage_episodes4.append(i_storage4)

flat_global_storage_episodes = [k for e in global_storage_episodes for k in e]
flat_global_storage_episodes2 = [k for e in global_storage_episodes2 for k in e]
flat_global_storage_episodes3 = [k for e in global_storage_episodes3 for k in e]
flat_global_storage_episodes4 = [k for e in global_storage_episodes4 for k in e]

# EQ Utilities

raw_data = {'Episode': flat_global_storage_episodes,
            'EQ utility': global_storage_player_eq_utilities,
            'Player': global_storage_player_names,
            'Game': global_storage_game_type}
df = pd.DataFrame(raw_data, columns = ['Episode', 'EQ utility', 'Player', 'Game'])

df.to_csv("TEST01_EQ_utilities")
df = pd.read_csv("TEST01_EQ_utilities")

sns.relplot(x="Episode", y="EQ utility", hue="Player", style="Player", col="Game", kind="line", data=df, legend="full")
plt.show()

# Utilities

raw_data2 = {'Episode': flat_global_storage_episodes2,
             'Utility': global_storage_player_utilities,
             'State': global_storage_game_states,
             'Player': global_storage_player_names2,
             'Game': global_storage_game_type2}
df2 = pd.DataFrame(raw_data2, columns = ['Episode', 'Utility', 'State', 'Player', 'Game'])

df2.to_csv("TEST01_utilities")
df2 = pd.read_csv("TEST01_utilities")

sns.relplot(x="Episode", y="Utility", hue="State", style="State", col="Player", row="Game", kind="line", data=df2, legend="full")
plt.show()

# Memory

raw_data3 = {'Episode': flat_global_storage_episodes3,
             'Memory': global_storage_memory,
             "Paired players": global_storage_player_names3}
df3 = pd.DataFrame(raw_data3, columns = ['Episode', 'Memory', 'Paired players'])

df3.to_csv("TEST01_memory")
df3 = pd.read_csv("TEST01_memory")

sns.relplot(x="Episode", y="Memory", hue="Paired players", kind="line", data=df3, legend="full")
plt.show()

# Discount rate

raw_data4 = {'Episode': flat_global_storage_episodes4,
             'Discount rate': global_storage_discount_rate}
df4 = pd.DataFrame(raw_data4, columns = ['Episode', 'Discount rate'])
df4.to_csv("TEST01_discount_rate")

df4 = pd.read_csv("TEST01_discount_rate")
sns.relplot(x="Episode", y="Discount rate", kind="line", data=df4, legend="full")
plt.show()

# Transfer balance

raw_data5 = {'Episode': flat_global_storage_episodes,
             'Transfer balance': global_storage_transfer_balance,
             'Player': global_storage_player_names,
             'Game': global_storage_game_type}
df5 = pd.DataFrame(raw_data5, columns = ['Episode', 'Transfer balance', 'Player', 'Game'])

df5.to_csv("TEST01_transfer_balance")
df5 = pd.read_csv("TEST01_transfer_balance")

sns.relplot(x="Episodes", y="Transfer balance", hue="Player", style="Player", col="Game", kind="line", data=df5)
plot.show()
